...
const handleLogin = async () => {
  ...
  try {
    ...
    else serverError.value = err.data?.message || 'ログインに失敗しました。'
  } finally {
    loading.value = false
  }
}
...
<template>
  <div class="page">
    ...
    <div class="mobile-top">
      ...
      <p class="mobile-tagline">スケジュールをスマートに管理しよう</p>
    ...
    <div class="left-panel">
      <div class="brand">
        ...
        <p class="brand-desc">チームと個人のスケジュールを<br />スマートに管理しよう</p>
      </div>
    ...
    <div class="right-panel">
      <div class="card">
        ...
        <p class="card-sub">アカウントにサインイン</p>
...
.right-panel {
  flex: 1;
  display: flex;
  align-items: flex-start; /* モバイルは上寄せ */
  justify-content: center;
...
@media (min-width: 1024px) {
  .right-panel {
    align-items: center; /* デスクトップは垂直中央 */
    padding: 2rem 1.5rem;
  }
}
